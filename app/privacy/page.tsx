...
export default function PrivacyPage() {
  return <InfoPage title="Privacy policy" intro="This page explains what information the site handles when you use its tools. Last updated July 4, 2026.">
    ...
    <InfoSection title="Accounts and service data"><p>If you sign in, the authentication provider supplies basic account details needed to identify the session. The site may retain usage totals and feedback you deliberately submit, including optional contact information.</p></InfoSection>
    ...
    <InfoSection title="Third-party services"><p>The site may connect to authentication, database, tournament-import, hosting, analytics, or advertising providers. Those providers process data under their own terms and privacy policies.</p></InfoSection>
    <InfoSection title="Questions"><p>For privacy questions or deletion requests, use the contact page and include enough detail to identify the relevant account or feedback submission.</p></InfoSection>
  </InfoPage>;
}
