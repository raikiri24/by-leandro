...
export const metadata: Metadata = {
  title: "About",
  description: "Why the free tournament card generator exists and how organizers can use it.",
...
export default function AboutPage() {
  return <InfoPage title="About this project" intro="Leandro's Tournament Card Generator is a free set of browser-based tools for tournament organizers and players who need clear event graphics without a full design workflow.">
    ...
    <InfoSection title="Independent project"><p>This is an independent community tool built and maintained by Leandro. It is not affiliated with Challonge, Google, Takara Tomy, Hasbro, or tournament venues represented in user-created graphics.</p></InfoSection>
    <InfoSection title="Support and updates"><p>Questions or bug reports go to <a className="text-primary underline" href={`mailto:${SUPPORT_EMAIL}`}>{SUPPORT_EMAIL}</a>. See the <a className="text-primary underline" href="/changelog">changelog</a> for recent updates, or the <a className="text-primary underline" href="/faq">FAQ</a> for common questions.</p></InfoSection>
  </InfoPage>;
}
